...
import pt.unl.fct.di.project.presentation.dto.UserLoginDTO
...
private fun addResponseToken(authentication: Authentication, response: HttpServletResponse) {
    ...
    claims["roles"] = authentication.authorities.map { it.authority.replace("ROLE_", "") }
...
class UserPasswordAuthenticationFilterToJWT (
    ...
    override fun attemptAuthentication(request: HttpServletRequest?,
        ...
        val user = ObjectMapper().readValue(request!!.inputStream, UserLoginDTO::class.java)
